...
IL_0047:
	...
	try
	{
		...
		}
		{
			...
			L_25 = VirtualFuncInvoker1< MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265*, int32_t >::Invoke(139, L_23, L_24);
			V_10 = L_25;
			V_11 = 0;
...
IL_00a5_1:
		{
			...
			L_37 = VirtualFuncInvoker0< ParameterInfoU5BU5D_t86995AB4A1693393FE29B058CC3FD727DF0B984C* >::Invoke(30, L_36);
			V_15 = L_37;
...
IL_00cd_1:
		...
		}
		{
			...
			NullCheck(L_50);
			Type_t* L_51;
			L_51 = VirtualFuncInvoker0< Type_t* >::Invoke(15, L_50);
			NullCheck(L_51);
			bool L_52;
...
IL_00fd_1:
		{
			...
			NullCheck(L_57);
			Type_t* L_58;
			L_58 = VirtualFuncInvoker0< Type_t* >::Invoke(15, L_57);
			...
			NullCheck(L_58);
			bool L_63;
			L_63 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(37, L_58, L_62);
