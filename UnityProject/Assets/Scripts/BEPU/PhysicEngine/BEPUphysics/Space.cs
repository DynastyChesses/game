...
namespace BEPUphysics
{
    ...
    public class Space
    {
        ...
        public Space(IParallelLooper parallelLooper)
        {
            ...
            // 统一继承于 ProcessingStage 或者 MultithreadedProcessingStage
            // 线程安全的缓冲对象管理
        ...
        {
            return RayCast(ray, Fix64.MaxValue, out result);
        }
        ...
        {
            return RayCast(ray, Fix64.MaxValue, filter, out result);
        }
