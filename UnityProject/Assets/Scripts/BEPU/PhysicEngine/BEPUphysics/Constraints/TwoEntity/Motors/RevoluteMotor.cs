...
namespace BEPUphysics.Constraints.TwoEntity.Motors
{
    ...
    public class RevoluteMotor : Motor, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        /// <summary>
        /// 构造一个新的约束，尝试旋转两个实体，使它们达到一个指定的相对方向围绕一个轴，完成初始化，指定连接(ConnectionA和ConnectionB)
        /// 以及基础和TestAxis。这个构造函数默认将约束的IsActive属性设置为false。
        /// </summary>
        ...
        /// <summary>
        /// 构造一个新的约束，尝试旋转两个实体，使它们围绕一个轴达到指定的相对方向。
        /// </summary>
        ...
        public void SetupJointTransforms(Vector3 motorizedAxis)
        {
            ...
            //Debug.Log("connectionA.orientationMatrix:" + connectionA.orientationMatrix);
