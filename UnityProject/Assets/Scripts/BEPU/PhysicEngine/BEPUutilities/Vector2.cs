...
namespace BEPUutilities
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        public static explicit operator UnityEngine.Vector2(Vector2 v2)//显式转换
        {
            return new UnityEngine.Vector2((float)v2.X,(float)v2.Y);
        }        
        public static explicit operator Vector2(UnityEngine.Vector2 v2)//显式转换
        {
            return new Vector2((Fix64)v2.x,(Fix64)v2.y);
        }
    }
}
