...
//
// public class IntSliderInputComponent : MonoBehaviour
// {
...
//         get
//         {
//             //Important!!不能用(int)转，会出现结果减1的情况，不知道为什么。。
//             return _minNum + Convert.ToInt32((_maxNum - _minNum) * slider.value);
//         }
//     }
//
...
//             if (null != slider)
//             {
//                 _sliderCollider = _sliderCollider ?? slider.GetComponent<BoxCollider>();
//                 _sliderCollider.enabled = _interactive;
//             }
//
//             if (null != addButton)
//             {
...
//         if(slider != null)
//             EventTriggerListener.Add(slider.onChange, OnSliderChange);
//         if(numInput != null)
//         {
// #if UNITY_EDITOR
...
//             if(_maxNum > _minNum)
//             {
//                 this.slider.value = (float)(_nowNum - _minNum) / (_maxNum - _minNum);
//             }
//             else if (_maxNum == _minNum)
//             {
...
//     void OnSliderChange()
//     {
//         SetVaule(value, null != numInput && !numInput.isSelected, false);
//     }
//
//     void OnInputChange()
//     {
