...
namespace SuperScrollView
{
    ...
    public class LoopGridView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        */
        ...
        public int GetFixedRowOrColumnCount()
        {
            return mFixedRowOrColumnCount;
        }
        ...
        public void RecreatePreviewItems(int addCount)
        {
            ...
            InitGridView(addCount, (gridView, itemIndex, row, column)=>{
                // 每种prefab都创建一些
                return gridView.NewListViewItem(mItemPrefabDataList[itemIndex % mItemPrefabDataList.Count].mItemPrefab.name);
                });
            UpdateCurFrameItemRangeData();
            UpdateAllGridSetting();
            UpdateGridViewContent();
