...
public class EasyTouch : MonoBehaviour {
	...
	void InitEasyTouch(){
		...
		#if ((!UNITY_ANDROID && !UNITY_IPHONE && !UNITY_WINRT && !UNITY_BLACKBERRY && !UNITY_WEBGL) || UNITY_EDITOR)
	...
	private void CreateGesture(int touchIndex,EventName message,Finger finger, SwipeDirection swipe, float swipeLength, Vector2 swipeVector){
		...
		Gesture gesture = Gesture.Allocate();
		finger.SetGesture(gesture);
	...
	public static bool GetTemporaryDisabled()
	{
		if (EasyTouch.instance != null)
		{
			return EasyTouch.instance.temporaryDisabled;
		}

		return false;
	}

	public static void SetTemporaryDisabled(bool value)
	{
		if (EasyTouch.instance != null)
		{
			EasyTouch.instance.temporaryDisabled = value;
		}	
	}
